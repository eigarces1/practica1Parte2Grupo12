...
Esta API recomienda películas según el género solicitado por el usuario o puede sugerir títulos aleatorios. Está diseñada para ejecutarse en un contenedor Docker y permite realizar operaciones CRUD sobre una colección de películas.
